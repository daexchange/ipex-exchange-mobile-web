  ...
  <div class="mymsg_wrapper">
    <div class="wrapper">
      <Menu :active-name="activename" :open-names="opennames" @on-open-change="sss" ref="test" :accordion="true">
        <div class="title">{{$t("common.center")}}</div>
        <Submenu name="1">
          <template slot="title">
            <span class="isclick"></span>
            <span class="content">{{$t("usercenter.zhanghuguanli")}}</span>
          </template>
          <MenuItem name="1-1">
        ...
        <Submenu name="2">
          <template slot="title">
            <span class="isclick"></span>
            <span class="content">{{$t("usercenter.exchangeaccount")}}</span>
          </template>
          <MenuItem name="2-1">
          ...
          <MenuItem name="2-5">
          <router-link to="/uc/transfer">{{$t('uc.finance.transfer.title')}}</router-link>
          </MenuItem>
        </Submenu>
        <Submenu name="5">
          <template slot="title">
            <span class="isclick"></span>
            <span class="content">{{$t("usercenter.legalcurrencyaccount")}}</span>
          </template>
          <MenuItem name="5-1">
          <router-link to="/uc/legalcurrencymoney">{{$t('uc.finance.personalassets')}}</router-link>
          </MenuItem>
          <MenuItem name="5-2">
          <router-link to="/uc/legalcurrencyrecord">{{$t('uc.finance.billdetail')}}</router-link>
          </MenuItem>
        </Submenu>
        <Submenu name="3">
          <template slot="title">
            <span class="isclick"></span>
            <span class="content">{{$t("usercenter.bibiguanli")}}</span>
          </template>
          <MenuItem name="3-1">
        ...
        <Submenu name="4">
          <template slot="title">
            <span class="isclick"></span>
            <span class="content">{{$t("usercenter.fabiguanli")}}</span>
          </template>
          <MenuItem name="4-1">
  ...
  data() {
    return {
      ...
      routeArr: {
        ...
        "/uc/ad/create":"4-3",
        "/uc/ad/update":"4-4",
		"/uc/legalcurrencymoney": "5-1",
		"/uc/legalcurrencyrecord": "5-2"
      }
    };
  },
  created: function() {
    ...
    link(code) {
      switch (code) {
        ...
        case "4-1":
          ...
          break;
        case "5-1":
          this.$router.push("/uc/legalcurrencymoney");
		  break;
		case "5-2":
          this.$router.push("/uc/legalcurrencyrecord");
          break;
        default:
          this.$router.push("/uc/safe");
          break;
