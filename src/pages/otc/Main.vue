    ...
    <div class="containers" id="List">
      <div class="fiat">
        <div class="to_business">
          <h3>{{$t("otc.fabijiaoyi")}}</h3>
          <span>{{$t("otc.kuaisumaimai")}}</span>
          <a href="javascript:void(0)" @click="goBusiness">{{$t("otc.chengweishangjia")}}</a>
      ...
      <div class="advantage">
        <ul>
          <li>
            ...
            <div class="title">{{$t("otc.scykj")}}</div>
            <div class="content1">{{$t("otc.shishibodong")}}</div>
          </li>
          <li>
            <div class="image"><img src="../../assets/images/poundage.png" alt=""></div>
            <div class="title">{{$t("otc.freeoffee")}}</div>
            <div class="content1">{{$t("otc.suojianjisuode")}}</div>
            <li>
              <div class="image"><img src="../../assets/images/instant.png" alt=""></div>
              <div class="title">{{$t("otc.jishichengjiao")}}</div>
              <div class="content1">{{$t("otc.zhinengpipei")}}</div>
            </li>
            <li>
              <div class="image"><img src="../../assets/images/platedanbao.png" alt=""></div>
              <div class="title">{{$t("otc.pingtaidanbao")}}</div>
              <div class="content1">{{$t("otc.pingtairenzheng")}}</div>
            </li>
        </ul>
      </div>
    </div>
