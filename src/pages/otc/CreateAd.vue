<template>
    <div class="main_background">
        <div>
            <h2 style="margin-bottom: 15px">创建一个广告交易</h2>
            <p>如果您经常进行交易，您可以创建自己的交易广告。如果您只是偶尔交易，我们建议您直接搜索交易广告。</p>
            <p>创建一则交易广告是免费的。</p>
            <p>若您想直接编辑已创建的广告，请查看我的广告。</p>
        </div>
        ...............................................................................................
        <div class="formbox" style="margin-top: 15px;">
            <Form label-position="top">
                ...
                <p class="msg" v-show="form.fixed" style="margin-bottom: 20px">{{$t('otc.publishad.usetip')}}</p>
                ...
                <p class="msg" style="margin-bottom: 20px">{{$t('otc.publishad.marketprice')}}：
                    <span class="cankao">{{cankao}}</span>
                </p>
                <p class="msg" v-show="!form.fixed" style="margin-bottom: 20px">{{$t('otc.publishad.marketpricetip')}}{{wantstyle}}。</p>
                <div class="ivu-form-item">
                    <label class="ivu-form-item-label" style="display: inline">{{$t('otc.publishad.exchangeprice')}}</label>
                    <div class="ivu-input-wrapper ivu-input-type" id="price" style="display: inline; margin-left: 10px">
                        {{price}}&nbsp;CNY/{{symbol}}
                    </div>
                </div>
                <p class="msg" style="margin-bottom: 20px">{{$t('otc.publishad.formual')}}：（Bitstamp+Bitfinex+Coinbase）/ 3 *{{gongshi.toFixed(4) }}</p>
                ...
                <p class="msg" style="margin-bottom: 20px">{{$t('otc.publishad.tip1')}} </p>
                <router-link to="/uc/account" style="color:#f0ac19;">{{$t('otc.publishad.tip2')}}</router-link>
                <FormItem :label="$t('otc.publishad.paymode')" prop="payMode" style="margin-top: 20px">
                ...
                <p class="msg" style="margin-bottom: 20px">{{$t('otc.publishad.msg5')}}</p>
