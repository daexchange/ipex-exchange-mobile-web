  ...
  methods: {
    ...
    toggleShow () {
      ...
      if (!test) {
        ...
        this.$refs.barPart.style.right = -this.$refs.barPart.offsetWidth + 'px'
        ...
        this.$refs.barPart.style.right = 0 + 'px'
      }
    }
  },
  mounted () {
    this.$refs.barPart.style.right = -this.$refs.barPart.offsetWidth + 'px'   // 初始化通过left值来隐藏侧边栏组件
